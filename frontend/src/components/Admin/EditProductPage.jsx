...
const EditProductPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Server error updating product");
        }
    };
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 bg-white dark:bg-stone-900 p-4 sm:p-8 lg:p-10 rounded-3xl border border-stone-200/80 dark:border-stone-800 shadow-sm">
                ...
                <div>
                    <label className="block text-xs uppercase tracking-[0.2em] text-stone-400 font-medium mb-3">
                        Product Images (Cloudinary Pipeline)
                    </label>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
                        ...
                        {(!productData.images || productData.images.length < 8) && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" value={productData.name || ""} onChange={handleChange} required className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="price" value={productData.price || ""} onChange={handleChange} required min="0" step="0.01" className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                    </div>

                    <div>
                        <label className="block text-xs uppercase tracking-[0.15em] text-stone-400 font-medium mb-2">Discount Price (₹)</label>
                        <input type="number" name="discountPrice" value={productData.discountPrice || ""} onChange={handleChange} min="0" step="0.01" className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                    </div>

                    <div>
                        <label className="block text-xs uppercase tracking-[0.15em] text-stone-400 font-medium mb-2">Stock Inventory *</label>
                        <input type="number" name="countInStock" value={productData.countInStock || ""} onChange={handleChange} required min="0" className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                    </div>

                    <div>
                        <label className="block text-xs uppercase tracking-[0.15em] text-stone-400 font-medium mb-2">Category *</label>
                        <select name="category" value={productData.category || "Top Wear"} onChange={handleChange} className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100">
                    ...
                    <div>
                        ...
                        <select name="collections" value={productData.collections || "Men"} onChange={handleChange} className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100">
                    ...
                    <div>
                        ...
                        <select name="gender" value={productData.gender || "Men"} onChange={handleChange} className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100">
                            <option value="Men">Men</option>
                            <option value="Women">Women</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="material" value={productData.material || ""} onChange={handleChange} required className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                    </div>

                    <div>
                        <label className="block text-xs uppercase tracking-[0.15em] text-stone-400 font-medium mb-2">Brand *</label>
                        <input type="text" name="brand" value={productData.brand || ""} onChange={handleChange} required className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" value={productData.description || ""} onChange={handleChange} required rows={4} className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-200 dark:border-stone-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-stone-900 dark:focus:border-stone-100" />
                </div>
