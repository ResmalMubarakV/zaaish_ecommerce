  ...
  return (
    <div className='p-4'>
        ...
        <div className='mb-6'>
            ...
            {sizes.map((size) => (
                <div key={size} className='flex flex-center mb-1'>
                    ...
                    className='mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-ray-300' />
        ...
        <div className='mb-6'>
            ...
            {materials.map((material) => (
                <div key={material} className='flex flex-center mb-1'>
        ...
        <div className='mb-6'>
            <label className='block text-gray-600 font-medium mb-2'>Size</label>
            {brands.map((brand) => (
                <div key={brand} className='flex flex-center mb-1'>
